...
from util import gen_dim_stats
...
mses, qs, lamopt = gen_dim_stats(
    beta0, ns, sigma, lams, None, ntrials=100, maxiter=200, ncv=50
)
save_csvs(problem, "ols", mses, qs, lamopt)
mses, qs, lamopt = gen_dim_stats(
    beta0, ns, sigma, lams, lpen1, ntrials=100, maxiter=200, ncv=50
)
save_csvs(problem, "lpen1", mses, qs, lamopt)
mses, qs, lamopt = gen_dim_stats(
    beta0, ns, sigma, lams, lpen2, ntrials=100, maxiter=200, ncv=50
)
save_csvs(problem, "lpen2", mses, qs, lamopt)
mses, qs, lamopt = gen_dim_stats(
    beta0, ns, sigma, lams, tpen1, ntrials=100, maxiter=200, ncv=50
)
save_csvs(problem, "tpen1", mses, qs, lamopt)
mses, qs, lamopt = gen_dim_stats(
    beta0, ns, sigma, lams, tpen2, ntrials=100, maxiter=200, ncv=50
)
